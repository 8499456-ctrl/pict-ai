...
async function processImage(request, env) {
  ...
  try {
    ...
    const models = {
      ...
      'travel-art': {
        model: 'black-forest-labs/flux-kontext-pro',
        input: { prompt: `Transform this exact travel, landscape, street, or architecture photo into a polished colorful travel-art illustration. Preserve the original place, architecture, landmark shapes, perspective, camera angle, sky, roads, plants, water, signs, flags, and overall composition. Style it like a clean illustrated postcard with refined ink lines, rich but natural colors, soft painterly shading, and clear architectural detail. Do not create a portrait, model, new person, character, face close-up, fantasy costume, logo, or unrelated scene. If people are tiny background figures, keep them tiny and unobtrusive; do not make them the subject.${prompt ? ` Additional user direction: ${prompt}` : ''}`, input_image: dataUri, aspect_ratio: 'match_input_image', output_format: 'jpg', safety_tolerance: 2, prompt_upsampling: false },
      },
      'product-poster': {
        model: 'black-forest-labs/flux-kontext-pro',
        input: { prompt: `Edit this uploaded image into a polished vertical poster-style visual for Pinterest, ecommerce, or social media. The uploaded main subject is the source of truth. Preserve the same main subject identity, shape, material, color, proportions, visible details, pose, camera angle, and overall recognizability. If the upload is a product or object, keep that exact product or object. If the upload is a person, portrait, pet, or non-product scene, keep the actual uploaded subject and make a clean poster-style composition around it; do not replace it with a bottle, package, vase, container, different person, or unrelated product. Create a clean commercial background, tasteful studio lighting, subtle shadows, and premium 4:5 composition. Absolutely no text, no headline, no fake brand name, no logo, no letters, no readable or unreadable typography, no prices, no watermark, and no added hands or unrelated objects. Leave empty space where text could be added later with a separate text tool.${prompt ? ` Additional user direction: ${prompt}` : ''}`, input_image: dataUri, aspect_ratio: '4:5', output_format: 'jpg', safety_tolerance: 2, prompt_upsampling: false },
      },
      art: {
        model: 'black-forest-labs/flux-kontext-pro',
...
(function(){
  ...
  const extras={
    en:{
      ...
      'nav.guides':'Guides','guides.label':'Detailed guides','guides.title':'Learn more by task','guides.intro':'These pages explain use cases, examples, and tips. Use the tool cards above when you are ready to edit.','guides.comic.title':'Photo to Comic','guides.comic.desc':'Turn portraits, pets, and travel photos into colorful comic-style illustrations.','guides.remove.title':'Remove Background','guides.remove.desc':'Create clean cutouts for products, people, profile images, and social posts.','guides.travel.title':'Travel Photo to Art','guides.travel.desc':'Transform travel snapshots into watercolor-style art for Pinterest and memories.','guides.compress.title':'Image Compressor','guides.compress.desc':'Reduce image file size and convert JPG, PNG, or WebP before sharing.','guides.resize.title':'Resize & Crop Image','guides.resize.desc':'Crop images for Pinterest, Instagram, YouTube, and other social formats.','guides.poster.title':'AI Product Poster','guides.poster.desc':'Turn a product photo into a polished poster-style image for shops and social posts.','guides.open':'Open guide →',
  ...
  const moduleCopy={
    en:{'tool.travel-art':'🌄 Travel Photo to Art','tool.travel-art.desc':'Turn landmarks, streets, buildings, and scenery into illustrated travel art.','tool.product-poster':'🛍️ AI Product Poster','tool.product-poster.desc':'Turn a product photo into a polished poster-style image for shops, Pinterest, and social posts.','tool.pin-before-after':'📌 Pinterest Before/After','tool.pin-before-after.desc':'Combine an original and edited image into a vertical Pinterest before/after pin.','local.pin-before-after.help':'Upload the original first, then add the edited result below. Pict creates a 2:3 Pinterest pin locally in your browser.','creativePromptLabel.travel-art':'Travel photo to art','creativePromptHelp.travel-art':'For architecture, landscapes, streets, and travel photos. Preserves the place, composition, and perspective without creating new people.','creativePromptLabel.product-poster':'Product poster direction','creativePromptHelp.product-poster':'Describe the poster mood, background, or audience. The product stays the main subject; avoid asking the AI to write exact prices or long text.'},
    zh:{'tool.travel-art':'🌄 旅行照片转艺术','tool.travel-art.desc':'把建筑、街景、风景和旅行照片变成插画风旅行艺术图。','tool.product-poster':'🛍️ AI 商品海报','tool.product-poster.desc':'把商品照片变成更适合店铺、Pinterest 和社交发布的海报风图片。','tool.pin-before-after':'📌 Pinterest 前后对比','tool.pin-before-after.desc':'把原图和处理结果合成一张 Pinterest 竖版前后对比图。','local.pin-before-after.help':'先上传原图，再在下方选择处理后的图片。Pict 会在浏览器本地生成 2:3 Pinterest 图片。','creativePromptLabel.travel-art':'旅行照片转艺术','creativePromptHelp.travel-art':'适合建筑、风景、街景和旅行照片。会尽量保留原始地点、构图和透视，不生成新人物。','creativePromptLabel.product-poster':'商品海报方向','creativePromptHelp.product-poster':'描述海报氛围、背景或目标人群。商品会作为主体保留；不建议让 AI 生成精确价格或长文字。'},
    es:{'tool.travel-art':'🌄 Foto de viaje a arte','tool.travel-art.desc':'Convierte lugares, calles, edificios y paisajes en arte ilustrado de viaje.','tool.product-poster':'🛍️ Poster de producto IA','tool.product-poster.desc':'Convierte una foto de producto en una imagen tipo poster para tiendas, Pinterest y redes.','tool.pin-before-after':'📌 Antes/despues para Pinterest','tool.pin-before-after.desc':'Combina la foto original y la editada en un pin vertical para Pinterest.','local.pin-before-after.help':'Sube primero la original y luego la imagen editada abajo. Pict crea un pin 2:3 localmente en tu navegador.','creativePromptLabel.travel-art':'Foto de viaje a arte','creativePromptHelp.travel-art':'Para arquitectura, paisajes, calles y viajes. Conserva lugar, composicion y perspectiva sin crear personas nuevas.','creativePromptLabel.product-poster':'Direccion del poster','creativePromptHelp.product-poster':'Describe el ambiente, fondo o publico. El producto sigue siendo el protagonista; evita precios exactos o texto largo.'},
    fr:{'tool.travel-art':'🌄 Photo de voyage en art','tool.travel-art.desc':'Transformez monuments, rues, batiments et paysages en illustration de voyage.','tool.product-poster':'🛍️ Affiche produit IA','tool.product-poster.desc':'Transformez une photo produit en visuel type affiche pour boutiques, Pinterest et reseaux.','tool.pin-before-after':'📌 Avant/apres Pinterest','tool.pin-before-after.desc':'Combinez l original et l image modifiee dans un pin vertical Pinterest.','local.pin-before-after.help':'Importez d abord l original, puis l image modifiee ci-dessous. Pict cree un pin 2:3 localement dans le navigateur.','creativePromptLabel.travel-art':'Photo de voyage en art','creativePromptHelp.travel-art':'Pour architecture, paysages, rues et voyages. Preserve le lieu, la composition et la perspective sans creer de nouvelles personnes.','creativePromptLabel.product-poster':'Direction de l affiche','creativePromptHelp.product-poster':'Decrivez l ambiance, le fond ou le public. Le produit reste le sujet principal; evitez les prix exacts ou longs textes.'},
    pt:{'tool.travel-art':'🌄 Foto de viagem em arte','tool.travel-art.desc':'Transforme lugares, ruas, edificios e paisagens em arte ilustrada de viagem.','tool.product-poster':'🛍️ Poster de produto IA','tool.product-poster.desc':'Transforme uma foto de produto em imagem estilo poster para lojas, Pinterest e redes sociais.','tool.pin-before-after':'📌 Antes/depois Pinterest','tool.pin-before-after.desc':'Combine a imagem original e editada em um pin vertical para Pinterest.','local.pin-before-after.help':'Envie primeiro a original e depois a imagem editada abaixo. O Pict cria um pin 2:3 localmente no navegador.','creativePromptLabel.travel-art':'Foto de viagem em arte','creativePromptHelp.travel-art':'Para arquitetura, paisagens, ruas e viagens. Preserva lugar, composicao e perspectiva sem criar novas pessoas.','creativePromptLabel.product-poster':'Direcao do poster','creativePromptHelp.product-poster':'Descreva clima, fundo ou publico. O produto permanece como assunto principal; evite precos exatos ou textos longos.'},
    ja:{'tool.travel-art':'🌄 旅行写真をアートに','tool.travel-art.desc':'名所、街並み、建物、風景を旅行イラストに変換します。','tool.product-poster':'🛍️ AI商品ポスター','tool.product-poster.desc':'商品写真をショップ、Pinterest、SNS向けのポスター風画像にします。','tool.pin-before-after':'📌 Pinterestビフォー/アフター','tool.pin-before-after.desc':'元画像と編集後画像をPinterest向けの縦長ピンに合成します。','local.pin-before-after.help':'先に元画像をアップロードし、下で編集後画像を選択します。Pictはブラウザ内で2:3ピンを作成します。','creativePromptLabel.travel-art':'旅行写真をアートに','creativePromptHelp.travel-art':'建築、風景、街並み、旅行写真向け。場所、構図、遠近感を保ち、新しい人物を作りません。','creativePromptLabel.product-poster':'商品ポスターの方向性','creativePromptHelp.product-poster':'雰囲気、背景、対象ユーザーを説明します。商品を主役に保ち、正確な価格や長い文字はAIに書かせないでください。'},
    ko:{'tool.travel-art':'🌄 여행 사진을 아트로','tool.travel-art.desc':'랜드마크, 거리, 건물, 풍경을 여행 일러스트로 바꿉니다.','tool.product-poster':'🛍️ AI 상품 포스터','tool.product-poster.desc':'상품 사진을 쇼핑몰, Pinterest, 소셜 게시물용 포스터 이미지로 바꿉니다.','tool.pin-before-after':'📌 Pinterest 전후 비교','tool.pin-before-after.desc':'원본과 편집 결과를 세로형 Pinterest 핀으로 합칩니다.','local.pin-before-after.help':'먼저 원본을 업로드한 뒤 아래에서 편집 결과를 선택하세요. Pict가 브라우저에서 2:3 핀을 만듭니다.','creativePromptLabel.travel-art':'여행 사진을 아트로','creativePromptHelp.travel-art':'건축, 풍경, 거리, 여행 사진용입니다. 장소, 구도, 원근을 보존하고 새 인물을 만들지 않습니다.','creativePromptLabel.product-poster':'상품 포스터 방향','creativePromptHelp.product-poster':'분위기, 배경, 대상 고객을 설명하세요. 상품은 주인공으로 유지되며 정확한 가격이나 긴 텍스트 생성은 피하세요.'},
    ar:{'tool.travel-art':'🌄 تحويل صورة السفر إلى فن','tool.travel-art.desc':'حوّل المعالم والشوارع والمباني والمناظر إلى فن سفر مرسوم.','tool.product-poster':'🛍️ ملصق منتج بالذكاء الاصطناعي','tool.product-poster.desc':'حوّل صورة منتج إلى ملصق مناسب للمتاجر وPinterest والمنشورات.','tool.pin-before-after':'📌 قبل/بعد لـ Pinterest','tool.pin-before-after.desc':'اجمع الصورة الأصلية والمعدلة في منشور عمودي لـ Pinterest.','local.pin-before-after.help':'ارفع الصورة الأصلية أولاً، ثم اختر الصورة المعدلة في الأسفل. ينشئ Pict صورة 2:3 محليًا داخل المتصفح.','creativePromptLabel.travel-art':'تحويل صورة السفر إلى فن','creativePromptHelp.travel-art':'للعمارة والمناظر والشوارع وصور السفر. يحافظ على المكان والتكوين والمنظور دون إنشاء أشخاص جدد.','creativePromptLabel.product-poster':'اتجاه ملصق المنتج','creativePromptHelp.product-poster':'صف المزاج أو الخلفية أو الجمهور. يبقى المنتج هو العنصر الرئيسي؛ تجنب طلب أسعار دقيقة أو نصوص طويلة.'},
    de:{'tool.travel-art':'🌄 Reisefoto zu Kunst','tool.travel-art.desc':'Verwandle Orte, Strassen, Gebaude und Landschaften in illustrierte Reisekunst.','tool.product-poster':'🛍️ KI-Produktposter','tool.product-poster.desc':'Verwandle ein Produktfoto in ein Posterbild fur Shops, Pinterest und Social Posts.','tool.pin-before-after':'📌 Pinterest Vorher/Nachher','tool.pin-before-after.desc':'Kombiniere Original und bearbeitetes Bild zu einem vertikalen Pinterest-Pin.','local.pin-before-after.help':'Lade zuerst das Original hoch und waehle unten das bearbeitete Bild. Pict erstellt lokal im Browser einen 2:3-Pin.','creativePromptLabel.travel-art':'Reisefoto zu Kunst','creativePromptHelp.travel-art':'Fur Architektur, Landschaften, Strassen und Reisefotos. Bewahrt Ort, Komposition und Perspektive ohne neue Personen.','creativePromptLabel.product-poster':'Poster-Richtung','creativePromptHelp.product-poster':'Beschreibe Stimmung, Hintergrund oder Zielgruppe. Das Produkt bleibt Hauptmotiv; vermeide exakte Preise oder lange Texte.'}
  };
  Object.keys(moduleCopy).forEach(lang=>Object.assign(i18n[lang]||(i18n[lang]={}),moduleCopy[lang]));
  const localTools=['add-text','resize-crop','compress-convert','pin-before-after'];
  const creativeTools=['comic-portrait','game-avatar','cartoon','travel-art','product-poster','art','change-background','remove-object','scene-lighting'];
...
function enhanceIndexHtml(html) {
  ...
  <div class="guide-label" data-i18n="guides.label">Detailed guides</div>
  <h2 class="guide-title" data-i18n="guides.title">Learn more by task</h2>
  <p class="guide-intro" data-i18n="guides.intro">These pages explain use cases, examples, and tips. Use the tool cards above when you are ready to edit.</p>
  <div class="guide-grid">
    ...
    <a class="guide-card" href="product-poster/">
      <div><strong data-i18n="guides.poster.title">AI Product Poster</strong><p data-i18n="guides.poster.desc">Turn a product photo into a polished poster-style image for shops and social posts.</p></div>
      <span data-i18n="guides.open">Open guide →</span>
    </a>
  </div>
</section>`;
