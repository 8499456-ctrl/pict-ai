...
(function(){
  ...
  const moduleCopy={
    en:{'tool.travel-art':'🌄 Travel Photo to Art','tool.travel-art.desc':'Turn landmarks, streets, buildings, and scenery into illustrated travel art.','tool.product-poster':'🛍️ Product Poster','tool.product-poster.desc':'Create a clean product poster with headline, price, and a ready-to-share layout.','local.product-poster.help':'Create a 4:5 product poster with headline, subtitle, and price. Processed only in this browser.','creativePromptLabel.travel-art':'Travel photo to art','creativePromptHelp.travel-art':'For architecture, landscapes, streets, and travel photos. Preserves the place, composition, and perspective without creating new people.'},
    zh:{'tool.travel-art':'🌄 旅行照片转艺术','tool.travel-art.desc':'把建筑、街景、风景和旅行照片变成插画风旅行艺术图。','tool.product-poster':'🛍️ 商品海报','tool.product-poster.desc':'用标题、价格和模板快速制作可分享的商品海报。','local.product-poster.help':'制作 4:5 商品海报，可添加标题、副标题和价格。图片只在本机处理。','creativePromptLabel.travel-art':'旅行照片转艺术','creativePromptHelp.travel-art':'适合建筑、风景、街景和旅行照片。会尽量保留原始地点、构图和透视，不生成新人物。'},
    es:{'tool.travel-art':'🌄 Foto de viaje a arte','tool.travel-art.desc':'Convierte lugares, calles, edificios y paisajes en arte ilustrado de viaje.','tool.product-poster':'🛍️ Poster de producto','tool.product-poster.desc':'Crea un poster de producto con titulo, precio y diseño listo para compartir.','local.product-poster.help':'Crea un poster 4:5 con titulo, subtitulo y precio en el navegador.','creativePromptLabel.travel-art':'Foto de viaje a arte','creativePromptHelp.travel-art':'Para arquitectura, paisajes, calles y viajes. Conserva lugar, composicion y perspectiva sin crear personas nuevas.'},
    fr:{'tool.travel-art':'🌄 Photo de voyage en art','tool.travel-art.desc':'Transformez monuments, rues, batiments et paysages en illustration de voyage.','tool.product-poster':'🛍️ Affiche produit','tool.product-poster.desc':'Creez une affiche produit avec titre, prix et mise en page prete a partager.','local.product-poster.help':'Creez une affiche 4:5 avec titre, sous-titre et prix dans le navigateur.','creativePromptLabel.travel-art':'Photo de voyage en art','creativePromptHelp.travel-art':'Pour architecture, paysages, rues et voyages. Preserve le lieu, la composition et la perspective sans creer de nouvelles personnes.'},
    pt:{'tool.travel-art':'🌄 Foto de viagem em arte','tool.travel-art.desc':'Transforme lugares, ruas, edificios e paisagens em arte ilustrada de viagem.','tool.product-poster':'🛍️ Poster de produto','tool.product-poster.desc':'Crie um poster de produto com titulo, preco e layout pronto para compartilhar.','local.product-poster.help':'Crie um poster 4:5 com titulo, subtitulo e preco no navegador.','creativePromptLabel.travel-art':'Foto de viagem em arte','creativePromptHelp.travel-art':'Para arquitetura, paisagens, ruas e viagens. Preserva lugar, composicao e perspectiva sem criar novas pessoas.'},
    ja:{'tool.travel-art':'🌄 旅行写真をアートに','tool.travel-art.desc':'名所、街並み、建物、風景を旅行イラストに変換します。','tool.product-poster':'🛍️ 商品ポスター','tool.product-poster.desc':'見出し、価格、共有しやすいレイアウトの商品ポスターを作成します。','local.product-poster.help':'ブラウザ内で見出し、サブタイトル、価格付きの4:5商品ポスターを作成します。','creativePromptLabel.travel-art':'旅行写真をアートに','creativePromptHelp.travel-art':'建築、風景、街並み、旅行写真向け。場所、構図、遠近感を保ち、新しい人物を作りません。'},
    ko:{'tool.travel-art':'🌄 여행 사진을 아트로','tool.travel-art.desc':'랜드마크, 거리, 건물, 풍경을 여행 일러스트로 바꿉니다.','tool.product-poster':'🛍️ 상품 포스터','tool.product-poster.desc':'제목, 가격, 공유용 레이아웃이 있는 상품 포스터를 만듭니다.','local.product-poster.help':'브라우저에서 제목, 부제, 가격이 있는 4:5 상품 포스터를 만듭니다.','creativePromptLabel.travel-art':'여행 사진을 아트로','creativePromptHelp.travel-art':'건축, 풍경, 거리, 여행 사진용입니다. 장소, 구도, 원근을 보존하고 새 인물을 만들지 않습니다.'},
    ar:{'tool.travel-art':'🌄 تحويل صورة السفر إلى فن','tool.travel-art.desc':'حوّل المعالم والشوارع والمباني والمناظر إلى فن سفر مرسوم.','tool.product-poster':'🛍️ ملصق منتج','tool.product-poster.desc':'أنشئ ملصق منتج بعنوان وسعر وتخطيط جاهز للمشاركة.','local.product-poster.help':'أنشئ ملصق منتج 4:5 بعنوان ووصف وسعر داخل المتصفح.','creativePromptLabel.travel-art':'تحويل صورة السفر إلى فن','creativePromptHelp.travel-art':'للعمارة والمناظر والشوارع وصور السفر. يحافظ على المكان والتكوين والمنظور دون إنشاء أشخاص جدد.'},
    de:{'tool.travel-art':'🌄 Reisefoto zu Kunst','tool.travel-art.desc':'Verwandle Orte, Strassen, Gebaude und Landschaften in illustrierte Reisekunst.','tool.product-poster':'🛍️ Produktposter','tool.product-poster.desc':'Erstelle ein Produktposter mit Titel, Preis und teilbarem Layout.','local.product-poster.help':'Erstelle ein 4:5 Produktposter mit Titel, Untertitel und Preis direkt im Browser.','creativePromptLabel.travel-art':'Reisefoto zu Kunst','creativePromptHelp.travel-art':'Fur Architektur, Landschaften, Strassen und Reisefotos. Bewahrt Ort, Komposition und Perspektive ohne neue Personen.'}
  };
  Object.keys(moduleCopy).forEach(lang=>Object.assign(i18n[lang]||(i18n[lang]={}),moduleCopy[lang]));
  const localTools=['add-text','resize-crop','compress-convert','product-poster'];
  const creativeTools=['comic-portrait','game-avatar','cartoon','travel-art','art','change-background','remove-object','scene-lighting'];
...
function enhanceIndexHtml(html) {
  ...
  <div class="guide-grid">
    ...
    <a class="guide-card" href="product-poster/">
      <div><strong data-i18n="guides.poster.title">Product Poster</strong><p data-i18n="guides.poster.desc">Make a clean 4:5 product poster with headline, subtitle, and price.</p></div>
      <span data-i18n="guides.open">Open guide →</span>
    </a>
  </div>
</section>`;
